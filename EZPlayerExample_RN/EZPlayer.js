...
class EZPlayer extends Component {
    static propTypes = {
        ...
        onPlayerPlayFinished: PropTypes.func,
        onPlayerClickNextButton: PropTypes.func,
        onPlayerClickSelections: PropTypes.func,
    ...
    constructor(props) {
        ...
        this.events = {
            ...
            onPlayerPlayFinished: this._onPlayerPlayFinished.bind(this),
            onPlayerClickNextButton: this._onPlayerClickNextButton.bind(this),
            onPlayerClickSelections: this._onPlayerClickSelections.bind(this),
        };
    ...
    _onPlayerPlayFinished(event) {
        console.log("[EZPlayer] onPlayerPlayFinished " + JSON.stringify(event.nativeEvent));
        if (typeof this.props.onPlayerPlayFinished === 'function') {
            this.props.onPlayerPlayFinished(...arguments);
        }
    }

    _onPlayerClickNextButton(event) {
        console.log("[EZPlayer] onPlayerClickNextButton " + JSON.stringify(event.nativeEvent));
        if (typeof this.props.onPlayerClickNextButton === 'function') {
            this.props.onPlayerClickNextButton(...arguments);
        }
    }

    _onPlayerClickSelections(event) {
        console.log("[EZPlayer] onPlayerClickSelections " + JSON.stringify(event.nativeEvent));
        if (typeof this.props.onPlayerClickSelections === 'function') {
            this.props.onPlayerClickSelections(...arguments);
        }
    }
    ...
    render() {
        return (
            <EZRNPlayerViewNative
                ...
                onPlayerPlayFinished={this.events.onPlayerPlayFinished}
                onPlayerClickNextButton={this.events.onPlayerClickNextButton}
                onPlayerClickSelections={this.events.onPlayerClickSelections}
            />
        )
    }
}
